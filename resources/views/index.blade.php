...
">
                ...
                <div data-animation-container class="flex-container">
                    ...
                    <div class="twelve-columns text-center">
                        <div data-animation-container class="container small bottom-padding-60 text-center">
                            @if ($indexpage->titel != '')
                                                        <h2 data-animation-child class="large-title text-height-10 text-color-1 overlay-anim-box2" data-animation="overlay-anim2">{{$indexpage->titel}}</h2><br>
                    ...
                    <div class="twelve-columns text-center">
                        <br>
                        <br>
                        <p data-animation-child class="p-letter-style text-color-4 text-height-13 fade-anim-box tr-delay04" data-animation="fade-anim" style="font-size: 40px;color: #1d2a3a;">{{$indexpage->message}}</p>
                    </div><!-- column end -->
    ...
    <section class="light-bg-1 bottom-padding-30 top-padding-120" data-midnight="black">
        <!-- container start -->
        <div data-animation-container class="container small bottom-padding-60 text-center">
            <h2 data-animation-child class="large-title text-height-10 text-color-1 overlay-anim-box2" data-animation="overlay-anim2">{{$indexpage->T_portfolio}}</h2><br>
                    ...
                    <div class="flex-container container small">
                        ...
                        <div data-animation-container class="six-columns">
                            ...
                            <div class="content-right-margin-40">
                                ...
                                <span  data-animation-child class="red-color overlay-anim-box2 overlay-dark-bg-2 tr-delay01" data-animation="overlay-anim2">{{ $prot->type_services }}</span><br>
                                    <span data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 tr-delay01" data-animation="overlay-anim2">{{ $prot->titel }}</span><br>

                                </h3>

                                <p data-animation-child class="p-style-small text-color-2 fade-anim-box tr-delay04" data-animation="fade-anim">{{ $prot->descraption }}</p><br>

                                <div data-animation-child class="arrow-btn-box top-margin-30 fade-anim-box tr-delay05" data-animation="fade-anim">
                                    <a href="{{ route('home.portfolio',['var'=>$prot->type_services]) }}" class="arrow-btn pointer-large animsition-link"style="background:#1b2550;">See more</a>
                                </div>
...
<div data-animation-container="" class="text-center">
                <h2 data-animation-child="" class="large-title text-height-10 text-color-1 overlay-anim-box2" data-animation="overlay-anim2">{{$indexpage->T_worked}}</h2><br>
